...
const AIChatMessage = ({ message }) => {
  ...
  if (isUser) return (
    <div className="flex justify-end"><div className="max-w-[75%] space-y-1">
      <div className="bg-blue-600/20 border border-blue-500/25 rounded-xl rounded-tr-sm px-4 py-3"><p className="text-sm text-slate-100 whitespace-pre-wrap leading-relaxed">{message.content}</p></div>
  ...
  if (message.role === 'blocked') return (
    <div className="flex justify-start"><div className="max-w-[85%] rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 space-y-2" role="alert">
  ...
  return (
    <div className="flex justify-start"><div className="max-w-[85%] space-y-1.5">
      <div className="bg-navy-800 border border-navy-600 rounded-xl rounded-tl-sm px-4 py-3 space-y-3"><AIResponseRenderer text={message.content} /><SecurityDecisionMeta message={message} /></div>
